<?php 
	...
	$default_search_criteria .= "<tr><td></td><td>" . elgg_echo("profile_manager:members:searchform:filter_proimage"). "<br />";
	$default_search_criteria .= elgg_view("input/radio", array("internalname" => "profilepicfilter", "value" => "no", "options" => array(elgg_echo('profile_manager:members:searchform:filter_proimage:yes') => 'yes',elgg_echo('profile_manager:members:searchform:filter_proimage:no') => 'no')));
	$default_search_criteria .= "</td></tr>";
	
	$default_search_criteria .= "<tr><td></td><td>" . elgg_echo("profile_manager:members:searchform:filter_memberlevels"). "<br />";
	$default_search_criteria .= elgg_view("input/radio", array("internalname" => "convo_memberlevels", "options" => array(elgg_echo('convo_memberlevels:color:bronze') => elgg_echo('convo_memberlevels:color:bronze'),elgg_echo('convo_memberlevels:color:silver') => elgg_echo('convo_memberlevels:color:silver'),elgg_echo('convo_memberlevels:color:gold') => elgg_echo('convo_memberlevels:color:gold'),elgg_echo('convo_memberlevels:color:platinum') => elgg_echo('convo_memberlevels:color:platinum'),elgg_echo('convo_memberlevels:color:elite') => elgg_echo('convo_memberlevels:color:elite'))));
	$default_search_criteria .= "</td></tr>";
